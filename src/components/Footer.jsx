    ...
    return (
        <footer className="bg-gray-900 text-gray-400">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
                {/* Top Section */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 pb-10 border-b border-gray-800/60">
                    {/* Brand */}
                    <div className="col-span-2 md:col-span-1">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-base font-bold text-white">MyServiceHub</span>
                        </div>
                        ...
                        <div className="flex gap-2.5">
                            {['facebook', 'twitter', 'instagram', 'linkedin'].map((social) => (
                                <a
                                    key={social}
                                    href="#"
                                    className="w-8 h-8 rounded-lg bg-gray-800/80 hover:bg-primary/20 hover:text-primary flex items-center justify-center transition-all duration-200 text-gray-500"
                                    aria-label={social}
                                >
                    ...
                    <div>
                        ...
                        <ul className="space-y-2.5">
                            {['Home Cleaning', 'Plumbing', 'Electrical', 'Painting', 'AC Repair'].map(
                                (link) => (
                                    <li key={link}>
                                        <a href="#" className="text-sm text-gray-500 hover:text-white transition-colors duration-200 inline-block">
                                            {link}
                                        </a>
                                    </li>
                                )
                    ...
                    <div>
                        ...
                        <ul className="space-y-2.5">
                            {['Help Center', 'Safety', 'Terms of Service', 'Privacy Policy', 'Contact Us'].map(
                                (link) => (
                                    <li key={link}>
                                        <a href="#" className="text-sm text-gray-500 hover:text-white transition-colors duration-200 inline-block">
                                            {link}
                ...
                <div className="pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <p className="text-xs text-gray-600">
                        © 2026 MyServiceHub. All rights reserved.
                    </p>
